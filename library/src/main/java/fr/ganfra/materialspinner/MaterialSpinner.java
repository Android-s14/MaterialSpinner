...
public class MaterialSpinner extends Spinner implements ValueAnimator.AnimatorUpdateListener {
	...
	private boolean showFloatingLabelAlways;
    ...
    */
	...
	private void initDimensions() {
		...
		underlineBottomSpacing =
				getResources().getDimensionPixelSize(R.dimen.underline_bottom_spacing);
		...
		rightLeftSpinnerPadding = alignLabels ?
				getResources().getDimensionPixelSize(R.dimen.right_left_spinner_padding) :
				0;
    ...
    */
	...
	private void setPadding() {
		super.setPadding(innerPaddingLeft,
	...
	private int prepareBottomPadding() {
		...
		if (error != null) {
			staticLayout = new StaticLayout(error,
			                                textPaint,
	...
	protected void onDraw(Canvas canvas) {
		...
		if (hint != null || floatingLabelText != null) {
			...
			if (floatingLabelAnimator.isRunning() || !floatingLabelVisible) {
				textPaint.setAlpha((int) ((0.8 * floatingLabelPercent + 0.2) * baseAlpha *
						floatingLabelPercent));
			}
			String textToDraw =
					floatingLabelText != null ? floatingLabelText.toString() : hint.toString();
			canvas.drawText(textToDraw,
			                startX + rightLeftSpinnerPadding,
			                startYFloatingLabel,
			                textPaint);
		}
    ...
    */
	...
	public void setShowFloatingLabelAlways(boolean show) {
		this.showFloatingLabelAlways = show;
	}
	...
	public void setOnItemSelectedListener(final OnItemSelectedListener listener) {
		...
		OnItemSelectedListener onItemSelectedListener = new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
				...
				if (hint != null || floatingLabelText != null) {
					if (!floatingLabelVisible && (position != 0 || showFloatingLabelAlways)) {
						showFloatingLabel();
					} else if (floatingLabelVisible &&
							(position == 0 && !showFloatingLabelAlways)) {
						hideFloatingLabel();
					}
				}
	...
	private class HintAdapter extends BaseAdapter {
		...
		public int getItemViewType(int position) {
			return (hint != null && position == 0) ?
					HINT_TYPE :
					mSpinnerAdapter.getItemViewType(position);
		}
		...
		private View buildView(int position,
			...
			if (convertView != null) {
				convertView =
						(convertView.getTag() != null && convertView.getTag() instanceof Integer &&
								(Integer) convertView.getTag() != HINT_TYPE) ? convertView : null;
			}
			position = hint != null ? position - 1 : position;
			return isDropDownView ? mSpinnerAdapter.getDropDownView(position, convertView,
			                                                        parent) :
